...
<%@page import="dao.Livro,dao.DataPadraoBrasil"%>
...
<title>Web Livros-Lista de livros</title>
<link
		...
		<div class="container" style="margin-bottom: 30px; margin-top: 30px;">
			...
			<div class="row">			
				<div class="mb-3 col-8">
					<input type="text" class="form-control" id="buscarlivro"
						aria-describedby="emailHelp" name="substring"
						placeholder="Nome do livro, autor(a), editora ou ano de lançamento">
				</div>
				<div class="col-2">
			...
			<div class="row ">
				<table class="table table-dark table-hover">
					...
					<tbody>
						<!-- Tabela - Corpo: registros filtrado -->
						<%
						...
						<tr>
							<td><%=i + 1%></td>
							<td><%=livrob.getId()%></td>
						    <td><%=livrob.getNome()%></td>
						    <td><%=livrob.getAutor()%></td>
							<td><%=livrob.getEditora()%></td>
							<td><%=dl%></td>
							<td><!-- Página Editar -->
								<%
				...
				<!-- Botão Inserir -->
				<div>
					<a href="inserir.jsp"><button type="button"	class="btn btn-success">Inserir</button></a>
				</div>
			</div>
		</div>
	</form>
