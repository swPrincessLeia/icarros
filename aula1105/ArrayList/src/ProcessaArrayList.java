...
public class ProcessaArrayList {
	...
	public static void teste(ArrayList<String> produtos, ArrayList<Double> precos) {
		...
		String msg = "10- voltar para o menu de opções \n 0-encerrar programa";
		int menu1 = 10;
		int tam = 2;
		...
		if (menu1 == 0) {
			...
			case 1:
				...
				for (int i = 0; i < tam; i++) {
					...
					System.out.print("Digite o preço do produto eletrônico: ");
			...
			case 2:
				System.out.println("Consultar nome e preço do produto");

				System.out.println("Informe o id do produto");
				int id = in.nextInt();
				System.out.println("produto: " + produtos.get(id - 1) + "\nPreço: R$ " + precos.get(id - 1));
			...
			case 5:
				...
				System.out.println("Alterar o preço do produto: \nInforma o id do produto");
				int te = in.nextInt();
				in.nextLine();
				System.out.println("Informa o novo preço");
